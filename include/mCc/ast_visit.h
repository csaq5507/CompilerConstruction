...
typedef void(*mCc_ast_single_expression_cb)(struct mCc_ast_single_expression *, void *);
typedef void(*mCc_ast_binary_expression_cb)(struct mCc_ast_expression *, void *);
