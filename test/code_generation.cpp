...
TEST(code_generation, get_literal_size)
{
	...
	ASSERT_EQ(get_literal_size(MCC_AST_LITERAL_TYPE_STRING), 4);

	ASSERT_EQ(get_literal_size(MCC_AST_LITERAL_TYPE_INT), 4);

	ASSERT_EQ(get_literal_size(MCC_AST_LITERAL_TYPE_FLOAT), 8);

	ASSERT_EQ(get_literal_size(MCC_AST_LITERAL_TYPE_BOOL), 4);
}
