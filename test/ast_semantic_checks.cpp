...
TEST(semantic_check, wrong_parameter_type) {
    ...
    const char input[] =
            " void func1(int a){} void main() {func1(2.0);}";
...
TEST(semantic_check, wrong_return_type) {
    ...
    const char input[] =
            "int func1(){int a; return;} void main() {}";
...
TEST(semantic_check, wrong_return_type2) {
    ...
    const char input[] =
            "void func1(){int a; return a;} void main() {}";
