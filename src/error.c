...
//SEMANTIC_CHECKS
const char * ERROR_BINARY_EX_TYPE_MISSMATCH = "expression types not compatible: %s %s %s";
const char * ERROR_WRONG_PARAMETER_TYPE = "function %s expect %d. parameter of type %s, %s given";
const char * ERROR_WRONG_RETURN_TYPE = "wrong return of type %s for function, expected %s";
const char * ERROR_WRONG_ASSIGNMENT_TYPE = "assignment types not compatible: %s = %s";
const char * ERROR_CONDITION_NOT_BOOLEAN = "condition of type %s, expected boolean";
